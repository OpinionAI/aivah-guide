...
*Full options panel showing all available controls: knowledge agents, voice settings, LLM models, and conversation history*
...
![Knowledge Agent Selection](/images/hub-options-knowledge-agents.png)
*Knowledge agent dropdown showing available agents like Presentation AgentX, Marketing Agent, and Welcome to Aivah with selection options*
