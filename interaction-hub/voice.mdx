---
title: "Hub Talk Mode"
description: "Advanced multilingual voice conversation with AI agents and avatars"
---
...
<Frame caption="Avatar chat – the 2D Character takes over the full canvas with mic and end-session controls">
  ![Avatar chat full-screen character](/images/avatar-chat-character-fullscreen.png)
</Frame>
...
<Frame caption="Avatar chat with transcription panel and presentation scene">
  ![Avatar chat with transcript](/images/avatar-chat-with-transcript.png)
</Frame>
