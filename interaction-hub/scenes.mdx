...
- **Website Display**: Show live websites from your knowledge agent sources
...
### Presentation Agent Scene 1 - Interactive
Interactive presentation environment where agents control slide progression.
...
### Presentation Agent Scene 2 - Interactive  
