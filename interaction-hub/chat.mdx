...
When the agent is producing a long asset (slide deck, podcast, mind map) the **Document Creating Banner** appears at the top of the conversation. It tells you what is being generated and disappears automatically once the asset is ready – you can keep chatting in the meantime.
