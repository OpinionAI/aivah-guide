...
**Agent Dropdown:**
- **Available Agents**: All created knowledge agents in dropdown menu
- **Switch Anytime**: Change agents without losing conversation context
- **Agent-Specific**: Each agent brings unique knowledge and capabilities
- **Seamless Transition**: Conversation continues with new agent context
