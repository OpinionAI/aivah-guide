...
### 🧠 Knowledge Agents
Build intelligent agents with specialized knowledge:
- Upload documents, URLs, and multimedia content
- Real-time API integration for live data
- Presentation agents for interactive demos
...
1. **Create Your First Agent** → Build a knowledge-powered AI assistant
2. **Design Your Avatar** → Customize your agent's visual appearance
3. **Test in the Hub** → Experience your agent in action
4. **Share with Others** → Deploy your agent for public use
5. **Add Integrations** → Connect to your favorite apps and services
...
### Core Workspaces
- **Knowledge**: Agent creation and training
...
1. **[Setup Your First Agent](./setup-your-first-agent)** - Create and configure your first knowledge agent
