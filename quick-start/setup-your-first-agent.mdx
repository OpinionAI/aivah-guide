...
Create your first AIVAH agent in 5 simple steps. This comprehensive guide walks you through building a knowledge-powered AI agent, designing its avatar, testing interactions, and sharing with the world.
...
1. **Sign in to AIVAH** and click **Knowledge** in the top navigation
2. In the left sidebar, click **Create New Agent**

### Configure Your Agent

![Knowledge Agent Creation](/images/hub-options-knowledge-agents.png)

**Agent Configuration:**
- **Agent Name**: Enter a descriptive name (e.g., "Marketing Assistant", "Product Expert")
- **Real-Time API**: ✅ Enable for conversational interactions
- **Presentation Mode**: Leave off for standard agents (enable only for presentation agents)
- **Multi Modal**: Enable if your plan supports image/video processing

### Add Knowledge Content

Your agent needs information to be helpful. Add knowledge in three ways:
...
1. Click **Create Agent** to build your knowledge base
...
- **Voice Setup**: Select from professional voice options (Alloy, Echo, Shimmer, etc.)
...
**Knowledge Agents:** Switch between different knowledge agents
![Knowledge Agent Options](/images/hub-options-knowledge-agents.png)
...
- **Agent Name**: Select which knowledge agent to use
