...
Real-Time API enables live, conversational interactions with your Aivah Agent, providing instant responses and seamless user experiences. This guide covers configuring and optimizing real-time features for Worker Agents and presenter experiences.

## Understanding Real-Time API

Real-Time API transforms your agent into a dynamic, conversational interface that:
...
<Steps>
  <Step title="Access Agent Creation">
    Navigate to **Agents** → **Create New Agent** in your Aivah dashboard.
  </Step>
...
<Steps>
  <Step title="Access Agent Settings">
    Select your existing agent from the Agents workspace sidebar.
  </Step>
...
Ready to explore different agent configurations? Learn about the various [Types of Agents](/knowledge-agent/types-of-agents) or return to the main [Agent Overview](/knowledge-agent/overview).
