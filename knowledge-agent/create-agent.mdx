...
<Steps>
  ...
  <Step title="Configure Core Features">
    ...
    - **Presentation**: Leave off to create a Worker Agent. Turn on to create a Realtime Interactive Presenter Agent.
    - **Real-Time API**: Keep enabled for live, conversational interactions across channels.
...
<Note>Realtime Interactive Presenter Agents manage a single PDF from the same settings screen. Delete the active file to replace it with an updated deck.</Note>
