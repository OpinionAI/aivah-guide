...
<Steps>
  ...
  <Step title="Crop the face">
    The **Crop** modal opens immediately after the upload. Drag the handles to frame the head and face, then confirm.
  </Step>
...
- **Edit** (pencil icon) – rename the character or re-crop the original image.
