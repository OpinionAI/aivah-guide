...
**Voice Selection**
Choose from the voice family that matches your agent’s LLM:
- **Gemini voices** *(Sportsman, Customer support, Sarah, Brooke, Katie, Zemo, ajith, duaila, azj, ajz, sjl, brit, Swissen)* when a Gemini model is selected
- **OpenAI Realtime voices** *(Alloy, Echo, Shimmer, Ash, Ballad, Coral, Sage, Verse, Cedar, Marin)* when an OpenAI Realtime model is selected
- Voice availability updates automatically if you change the model in the LLM picker
