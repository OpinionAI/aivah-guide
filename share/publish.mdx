...
- **Agent Name**: Define the agent's display name (e.g., "Presentation AgentX")
- **Voice Selection**: Choose from Alloy, Echo, Shimmer, Ash, Ballad, Coral, Sage
- **LLM Model**: Select GPT-4o Mini Realtime or other available models
...
- **OpenAI Realtime Models**: Select from available models including:
  - GPT-4o Mini Realtime
  - GPT-4o Realtime  
  - Gemini 2.0 Flash Live Realtime
...
- **OpenAI Realtime**: GPT-4o Mini Realtime, GPT-4o Realtime
- **Gemini Models**: Gemini 2.0 Flash Live Realtime
- **Model-specific Features**: Each model has different capabilities and performance characteristics
