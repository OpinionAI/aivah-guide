...
<Steps>
  <Step title="Open the create flow">
    Click the **+** icon in the Shared header to open `/shared/create`.
  </Step>
  <Step title="Pick the agent">
    Choose the agent you want to publish. Both knowledge-base and presenter agents can be shared.
  </Step>
  <Step title="Configure the lead form">
  ...
  <Step title="Customize appearance (optional)">
    Tune branding, suggested prompts, hide / show microphone, and any other public-chat options.
  </Step>
  <Step title="Save">
    Aivah generates a public URL plus a copy-ready embed snippet. The agent now appears in the Shared list.
  </Step>
</Steps>
