...
Submitted leads stream into [Insights → Leads](/insights/leads) where you can review and export them.
...
<Frame caption="Data Collection Form modal – Title, User Consent Text, fields, and Add new input">
...
- **Data Type**: Name, Email, Phone, Text, Number, etc.
