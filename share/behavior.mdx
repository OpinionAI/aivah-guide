...
### Naming and Branding
- **Agent Name**: Set a custom name for your agent (e.g., "Product Presenter")
...
- **Companion Voice**: Select Gemini voices (Sportsman, Customer support, Sarah, etc.) or OpenAI Realtime voices (Alloy, Echo, Shimmer, Ash, Ballad, Coral, Sage, Verse, Cedar, Marin) based on the active model
- **LLM Model**: Choose the underlying model family (OpenAI GPT 4.1/5 series, Gemini 2.5 series, OpenAI Realtime, or Groq-hosted models)
