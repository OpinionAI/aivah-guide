...
- **Agent Selection**: Assign a Worker Agent tailored to each call type
...
- ✅ Worker Agent configured with the required knowledge sources
...
2. Choose your **Agent** for call handling (Worker Agents recommended)
...
- **Skills-Based Routing**: Route calls to specialized Worker Agents
