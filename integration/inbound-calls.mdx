...
- **OpenAI Realtime**: GPT Realtime, GPT‑4o Realtime, GPT Realtime Mini for ultra-low latency call handling
- **Gemini 2.5**: Flash Lite, Flash, Pro for Google’s realtime, multimodal pipeline
...
2. Choose your **Agent** for call handling (Worker for broad knowledge, Presenter when a live deck is required)
