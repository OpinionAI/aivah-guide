...
- Knowledge base and LLM model configured
...
### Step 2: Knowledge Agent Selection

Choose the appropriate knowledge agent for your use case:

![Select Knowledge Agent](/integration/Integerations%20/Integeration%20with%20%20Twillio%20%20Select%20Knwoledge%20Agent.png)

Options include:
- **Presentation AgentX**: Specialized for business presentations and demos
- **Marketing Agent**: Optimized for marketing and sales conversations
- **Custom Agents**: Your own trained knowledge agents
